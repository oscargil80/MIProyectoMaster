...
/*
//typealias tar = tarjetas

fun main (){


    var tar = Etarjetas.gris
 */
/*   println("Hola  "+Etarjetas.oro.name)
    println("Hola  "+tar.declaringClass)
    println("Hola  "+tar.ordinal)*//*


    //tar = 10

    var tarje : Array<Etarjetas> = Etarjetas.values()

    tarje.forEach { println(it)  }
  when (tar){
      Etarjetas.gris -> println("la tarjeta es gris")
      Etarjetas.oro -> println("la tarjeta es Dorada")
      Etarjetas.platino -> println("la tarjeta es platino")
  }

}

enum class Etarjetas(var valor : Int){
    gris(25),
    oro(18),
    platino(10)
}*/
